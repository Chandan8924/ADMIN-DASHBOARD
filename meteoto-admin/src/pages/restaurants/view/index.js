            ...
            result?.members && result?.members.length > 0 &&
              result?.members.map((elm) => {
                setProfilesListData((prev) => [...prev, {
                  image: elm?.photo ? `${${process.env.REACT_APP_IMG}}/${elm?.photo}` : team2,
                  name: elm?.name,
            ...
            <TabPanel value={value} index={0} dir={theme.direction}>
              ...
              >
                ...
                <Grid container spacing={3} alignItems="center">
                  <Grid item>
                    <SoftAvatar
                      src={data[0]?.logo?`${${process.env.REACT_APP_IMG}}/${data[0]?.logo}`:burceMars}
                      alt="profile-image"
                      variant="rounded"
                      size="xl"
                      shadow="sm"
              ...
              >
                ...
                <Grid container spacing={3} alignItems="center">
                  <Grid item>
                    <SoftAvatar
                      src={data[0]?.userId?.userImage?`${${process.env.REACT_APP_IMG}}/${data[0]?.userId?.userImage}`:burceMars}
                      alt="profile-image"
                      variant="rounded"
                      size="xl"
                      shadow="sm"
